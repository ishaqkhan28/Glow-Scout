    ...
    <section className="bg-[#F8F8F8]">
      <div className="container mx-auto flex px-5 md:flex-row flex-col items-center" >
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center" >
          ...
          <div className="flex flex-wrap space-x-4 absolute ml-56 mt-[350px] border-2 bg-[#F6E9CE99] p-3 rounded-full z-10 ">
            <select
              value={goal}
              onChange={(e) => setGoal(e.target.value)}
              className="bg-gray-100 border w-[350px] h-[40px] rounded-full p-2 opacity-30 font-bold border-[#351120]"
            >
            ...
            <select
              ...
              className="bg-gray-100 border w-[350px] h-[40px] rounded-full p-2 z-10 opacity-30 font-bold border-[#351120]"
            >
        ...
        <div className="relative ">
          <Image className="" alt="hero" loading = 'eager' src="/images/beautiful-woman-white-dress-white-background-portrait-with-beautiful-long-hair-touching-face 1.svg" width={520} height={520} />
        </div>
      </div>
    </section>
  )
