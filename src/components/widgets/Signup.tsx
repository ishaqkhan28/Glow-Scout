...
function Signup() {
  return (
    ...
    <div className="flex-grow flex flex-col items-center justify-center bg-[#F8F8F8] py-10">
        <h1 className="text-7xl font-semibold mb-4">Are you a business?</h1>
        <p className="text-2xl mb-6">
          People are seeking for the specialist. <br/> Join us now and serve your skills.
        </p>
          <button className="bg-[#F8F8F8] text-[#351120] px-10 py-4 gap-4 text-2xl font-Raleway rounded-full border-2 border-[#816d75] flex">
            Sign Up as Business
            <svg className="bg-[#351120] rounded-full " width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
